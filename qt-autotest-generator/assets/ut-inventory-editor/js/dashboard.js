...
async function dashRunTest(name,mode){
  if(!dashBase()){toast('无 server 连接','warn');return}
...
async function pollTestStatus(){
  if(!dashBase()){S.dash.testPolling=false;return}
  let anyActive=false;
  try{
